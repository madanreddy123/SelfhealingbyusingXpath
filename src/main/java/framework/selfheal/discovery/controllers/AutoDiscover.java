...
//
//import framework.selfheal.discovery.ElementNotFoundException;
...
//     */
//    public static String getCachedLocator(Map<String,String> characteristics) {
...
//        if (locator == null) System.out.println("Locator not in cache: " + key);
...
//     */
//    private static String filterByLabel(List<Element> labels, Map<String,String> characteristics) throws ElementNotFoundException, Exception {
...
//                Element element = getDocument().attr("text", id);
//                String cssSelector = element.text();
//                cache.put(flatten(characteristics), cssSelector);
//                characteristics.put("xpath", cssSelector);
//                return cssSelector;
//            } else {
